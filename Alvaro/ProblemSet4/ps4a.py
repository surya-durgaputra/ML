...
def isValidWord(word, hand, wordList):
    ...
    # if word not in wordlist, return error/False
    if word not in wordList:
        return False
    
    #make a dictionary out of the word
    #word_dict: dictionary (string -> int)
    #the keys are letters in the word 
    #the values are the respective frequency of letter in word
    word_dict = getFrequencyDict(word)

    #word is in wordlist
    #we now check if letters in word are in hand
